...
var touchPoints = function touchPoints(aPt, bPt) {
  ...
  var aXMiss = cmp2(mx, aPt.x) !== 0;
  if (aXMiss && cmp2(mx, bPt.x) !== 0) return false;
  var my = (aPt.y + bPt.y) / 2;
  var aYMiss = cmp2(my, aPt.y) !== 0;
  if (aYMiss && cmp2(my, bPt.y) !== 0) return false; // we have touching on both x & y, we have to make sure it's
